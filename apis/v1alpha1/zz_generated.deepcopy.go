...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RespCredentials) DeepCopyInto(out *RespCredentials) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RespCredentials.
func (in *RespCredentials) DeepCopy() *RespCredentials {
	if in == nil {
		return nil
	}
	out := new(RespCredentials)
	in.DeepCopyInto(out)
	return out
}
