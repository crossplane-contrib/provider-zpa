# Building and Installing the Crossplane zpa Provider

`provider-zpa` is composed of a golang project and can be built directly with
...
You can build the Crossplane zpa Provider for the host platform by
